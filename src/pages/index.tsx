...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Car Sharing Application v2`}</title>

        <meta
          name="description"
          content="Welcome to Car Sharing Application v2, your ultimate platform for seamless vehicle sharing. Experience the joy of sharing rides with ease and convenience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Car Sharing Application v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application v2, your ultimate platform for seamless vehicle sharing. Experience the joy of sharing rides with ease and convenience.`}
            </Text>
            <Box
